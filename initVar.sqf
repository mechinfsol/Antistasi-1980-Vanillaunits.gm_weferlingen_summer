...
antistasiVersion = "v 1.4.0.2-WIP";
...
arrayCivVeh = if !(hayIFA) then
	{
	["gm_gc_dp_p601","gm_gc_civ_p601","gm_ge_civ_typ1200","gm_ge_dbp_typ1200","C_Truck_02_fuel_F","RHS_Ural_Open_Civ_03","C_Truck_02_box_F","gm_xx_civ_bicycle_01","gm_xx_civ_bicycle_01"];
	}
else
	{
...
if (!hayIFA) then
	...
	if (!activeAFRF) then 
		{
		call compile preProcessFileLineNumbers "Templates\muyMalosVanilla.sqf"} else {call compile preProcessFileLineNumbers "Templates\muyMalosRHSAFRF.sqf"
		};
...
vehFastRope = ["O_Heli_Light_02_unarmed_F","B_Heli_Transport_01_camo_F","RHS_UH60M_d","len_mi8amt_nva","RHS_Mi8MTV3_vvsc"];
vehUnlimited = vehNATONormal + vehCSATNormal + [vehNATORBoat,vehNATOPatrolHeli,vehCSATRBoat,vehCSATPatrolHeli,NATOMG,NATOMortar,CSATMG,CSATMortar];
...
arrayCivs = if (worldName == "Tanoa") then
	...
	if !(hayIFA) then
		{
		["gm_gc_civ_man_01_80_blk","gm_gc_civ_man_01_80_blu","gm_gc_civ_man_02_80_gry","gm_gc_civ_man_02_80_brn","gm_ge_dbp_man_01_80_blu"]
		}
	else
		{
		["gm_gc_civ_man_01_80_blk","gm_gc_civ_man_01_80_blu","gm_gc_civ_man_02_80_gry","gm_gc_civ_man_02_80_brn","gm_ge_dbp_man_01_80_blu"]
...
if (worldName == "Tanoa") then
	...
	if (worldName == "Altis") then
		...
		{
		roadsMrk = ["road","road_1","road_2","road_3","road_4","road_5","road_6","road_7","road_8","road_9","road_10","road_11","road_12","road_13","road_14","road_15","road_16","road_17","road_18","road_19","road_20","road_21","road_22","road_23","road_24","road_25","road_26","road_27","road_28","road_29","road_30","road_31","road_32","road_33","road_34","road_35","road_36","road_37","road_38","road_39","road_40","road_41","road_42","road_43","road_44","road_45","road_46","road47","road_48","road_49","road_50","road_51","road_51","road_52","road_53","road_54","road_55","road_56","road_57","road_58","road_59","road_60","road_61","road_62","road_63","road_64","road_65","road_66","road_67","road_68","road_69","road_70","road_71","road_72","road_73","road_74","road_75","road_76","road_77","road_78","road_79","road_80","road_81","road_82","road_83","road_84","road_85","road_86","road_87"];
		{_x setMarkerAlpha 0} forEach roadsMrk;
...
server setVariable [vehSDKBike,25,true];//50
