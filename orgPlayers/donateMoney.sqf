...
if (_resourcesPlayer < 100) exitWith {hint "You have less than 100 DM to donate"};
...
if (count _this == 0) exitWith
	...
	hint "You have donated 100 DM to the cause. This will raise your status among our forces";
...
hint format ["You have donated 100 DM to %1", name _target];
