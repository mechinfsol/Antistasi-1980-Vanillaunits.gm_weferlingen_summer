...
class HQ_menu 			{
	...
	class controls {
		...
		{
			idc = 104; 	//L1
			text = "Grab 100 DM from Pool"; //--- ToDo: Localize;
			x = 0.272481 * safezoneW + safezoneX;
			y = 0.317959 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			tooltip = "Take 100 DM from faction pool and add it to your personnal account. It will damage your position among the faction in the commander career";
...
class player_money 			{
	...
	class controls {
		...
		{
			idc = -1;
			text = "Donate 100 DM to player"; //--- ToDo: Localize;
			x = 0.482498 * safezoneW + safezoneX;
			y = 0.317959 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
		...
		{
			idc = -1;
			text = "Donate 100 DM to Faction"; //--- ToDo: Localize;
			x = 0.482498 * safezoneW + safezoneX;
			y = 0.415981 * safezoneH + safezoneY;
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
