...
if (_resourcesFIA < _coste) then {_exit = true;hint format ["You do not have enough money for this request (%1 DM required)",_coste]};
...
if (str (_display) != "no display") then
	...
	_ChildControl  ctrlSetTooltip format ["Buy a vehicle for this squad for %1 DM",_coste];
...
vehQuery = nil;
//_resourcesFIA = server getVariable "resourcesFIA";
//if (_resourcesFIA < _coste) exitWith {hint format ["You do not have enough money for this vehicle: %1 DM required",_coste]};
